...
\begin{center}
	...
	\begin{tabular}{|p{1.5cm}|p{2cm}|p{8.5cm}|p{8.5cm}|p{5cm}|}
		...
		\cline{1-2}\ccline{3-3}{gris}\cline{4-5}
		GecuS.5 & 3.1.2.3.5 & Cliquer sur un compte et cliquer sur le bouton "-" présent en bas a droite de la partie droite & Le compte est banni après confirmation. & \\ 							\cline{1-2}\cline{4-5}
...
\begin{center}
	...
	\begin{tabular}{|p{2.5cm}|p{2cm}|p{8cm}|p{8cm}|p{5cm}|}
		...
		\rowcolor{gris}Référence & Exigence & Test & Résultat attendu & Résultat/Commentaires\\
		\hline
		\rowcolor{red}CrypS.1 & 3.1.3.1.1 & & & \\
		\cline{1-2}\ccline{3-3}{gris}\cline{4-5}
