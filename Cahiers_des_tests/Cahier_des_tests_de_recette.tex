...
\begin{center}
	\bgroup
	\def\arraystretch{1.5}
	\begin{tabular}{|p{2.2cm}|p{2cm}|p{8.5cm}|p{8.5cm}|p{5cm}|}
		\hline
		\rowcolor{gris}Référence & Exigence & Test & Résultat attendu & Résultat/Commentaires\\
		\cline{1-2}\ccline{3-3}{gris}\cline{4-5}
...
\begin{center}
	...
	\begin{tabular}{|p{2.2cm}|p{2cm}|p{8.5cm}|p{8.5cm}|p{5cm}|}
		...
		\cline{1-2}\cline{4-5}
		GecuS.1.3.2.1.1.3 & 3.2.6.2.1.3 & & Un champs de type selection de fichier & \\
		\cline{1-2}\cline{4-5}
...
\begin{center}
	...
	\begin{tabular}{|p{2.2cm}|p{2cm}|p{8.5cm}|p{8.5cm}|p{5cm}|}
		...
		\cline{1-2}\cline{4-5}
		BancS.1.1.1 & 3.1.2.6.1.1.1 & & Une case à coché alignée avec le texte "Supprimer le compte" & \\
		\cline{1-2}\cline{4-5}
		BancS.1.1.2 & 3.1.2.6.1.1.2 & & Une case à coché alignée avec le texte "Bannir le compte" & \\
		\cline{1-2}\ccline{3-3}{gris}\cline{4-5}
		...
		\cline{1-2}\ccline{3-3}{gris}\cline{4-5}
		BancS.1.4 & 3.1.2.6.1.4 & Cocher "Supprimer le compte" & Seul les 2 cases ( dont supprimer le compte" coché ) plus les 2 boutons sont présent. & \\
		\cline{1-2}\ccline{3-3}{gris}\cline{4-5}
		...
		\cline{1-2}\ccline{3-3}{gris}\cline{4-5}
		BancS.2 & 3.1.2.4.2 & Et retirer les droits sur un fichier. & Ouvrir le fichier .acc et vérifié que les droits sur le fichier ont été retiré. & \\
		\cline{1-2}\ccline{3-3}{gris}\cline{4-5}
		BancS.3 & 3.1.2.4.3 & Bannir temporairement une personne. & Verifier que le fichier .accban est mis à jours. & \\
		\cline{1-2}\ccline{3-3}{gris}\cline{4-5}
...
\begin{center}
	...
	\begin{tabular}{|p{2.2cm}|p{2cm}|p{8.5cm}|p{8.5cm}|p{5cm}|}
		...
		\rowcolor{gris}Référence & Exigence & Test & Résultat attendu & Résultat/Commentaires\\
		\hline
		BantS.1 & 3.1.2.5.1 & Cliquer sur un compte puis sur "-" présent sur la zone de gauche. & Un chams permet de donner une durée. & \\
		\cline{1-2}\ccline{3-3}{gris}\cline{4-5}
...
\begin{center}
	...
	\begin{tabular}{|p{2.2cm}|p{2cm}|p{8.5cm}|p{8.5cm}|p{5cm}|}
		...
		\cline{1-2}\cline{4-5}
		BanpS.2.1.1.1 & 3.1.2.6.3.5 & Cliquer sur le "+" & Un pop-up apparait, celui ci permettant de selectionner des fichiers & \\
		\cline{1-2}\ccline{3-3}{gris}\cline{4-5}
