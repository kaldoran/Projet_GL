...
\begin{center}
	...
	\begin{tabular}{|p{2.5cm}|p{2cm}|p{8cm}|p{8cm}|p{5cm}|}
		...
		\rowcolor{gris}Référence & Exigence & Test & Résultat attendu & Résultat/Commentaires\\
		\hline
		PafiS.1 & 3.1.2.2.1 & Créer un compte et essayer de partager des fichiers présent a partir de la racine. & Les fichiers ne doivent pas être accessible. & \\
		\cline{1-2}\ccline{3-3}{gris}\cline{4-5}
		PafiS.2 & 3.1.2.2.2 & Créer 2 comptes et partager un même fichier a ses 2 comptes & Se connecter sur les 2 comptes et vérifier l'accès aux fichiers. & \\
		\cline{1-2}\ccline{3-3}{gris}\cline{4-5}
		PafiS.3 & 3.1.2.2.3 & Créer un compte lui partager un fichier et bloqué l'accès a un sous dossier & Se connecter sur le compte crée, le fichier ne doit pas être présent dans la liste des fichiers. & \\
		\cline{1-2}\ccline{3-3}{gris}\cline{4-5}
...
\begin{center}
	...
	\begin{tabular}{|p{2.5cm}|p{2cm}|p{8cm}|p{8cm}|p{5cm}|}
		...
		\rowcolor{gris}Référence & Exigence & Test & Résultat attendu & Résultat/Commentaires\\
		\hline
		GecuS.1 & 3.1.2.3.1.1 & Ouvrir le logiciel & Une zone est présente a gauche. & \\
		\cline{1-2}\cline{4-5}
		...
		\cline{1-2}\ccline{3-3}{gris}\cline{4-5}
		GecuS.1.3.1 & 3.1.2.3.1.4.1 & & Un bouton "-" rouge est présent en bas a droite & \\
		\cline{1-2}\cline{4-5}
		GecuS.1.3.1.1 & 3.1.2.3.1.4.2 & Cliquer sur le bouton "-" & Un pop-up apparait. & \\
		\cline{1-2}\cline{4-5}
		GecuS.1.3.2 & 3.1.2.3.1.4.3 & & Un bouton "+" vert est présent en bas a droite & \\
		\cline{1-2}\ccline{3-3}{gris}\cline{4-5}
		...
		\cline{1-2}\cline{4-5}
		GecuS.1.3.3 & 3.2.6.2.3 & & En bas a droite se trouve un bouton annulé & \\
		\cline{1-2}\cline{4-5}
		GecuS.1.3.4 & 3.2.6.2.4 & & En bas a gauche un bouton "Valider" est présent & \\ 
		\cline{1-2}\cline{4-5}
...
\begin{center}
	...
	\begin{tabular}{|p{2.5cm}|p{2cm}|p{8cm}|p{8cm}|p{5cm}|}
		...
		\cline{1-2}\ccline{3-3}{gris}\cline{4-5}
		GecuS.5 & 3.1.2.3.4 & Cliquer sur un compte & La liste des fichiers auquel il a accès se trouve a droite et un plus est présent en bas a droite. & \\
		\cline{1-2}\ccline{3-3}{gris}\cline{4-5}
		GecuS.6 & 3.1.2.3.5 & Cliquer sur un compte et cliquer sur le bouton "-" présent en bas a droite de la partie droite & Le compte est banni après confirmation. & \\
		\cline{1-2}\cline{4-5}
...
\begin{center}
	...
	\begin{tabular}{|p{2.5cm}|p{2cm}|p{8cm}|p{8cm}|p{5cm}|}
		...
		\cline{1-2}\ccline{3-3}{gris}\cline{4-5}
		BancS.3 & 3.1.2.4.3 & Bannir temporairement une personne. & Verifier que le fichier .accban est mis a jours. & \\
		\cline{1-2}\ccline{3-3}{gris}\cline{4-5}
...
\begin{center}
	...
	\begin{tabular}{|p{2.5cm}|p{2cm}|p{8cm}|p{8cm}|p{5cm}|}
		...
		\cline{1-2}\ccline{3-3}{gris}\cline{4-5}
		BantS.2 & 3.1.2.5.2 & Cliquer sur un compte bannis. & Le temps restant apparait a droite. & \\
		\cline{1-2}\ccline{3-3}{gris}\cline{4-5}
...
\begin{center}
	...
	\begin{tabular}{|p{2.5cm}|p{2cm}|p{8cm}|p{8cm}|p{5cm}|}
		...
		\cline{1-2}\cline{4-5}
		BanpS.2.1 & 3.1.2.6.3.3 & & 2 Champs sont présent en bas a droite de la partie de droite. & \\
		\cline{1-2}\ccline{3-3}{gris}\cline{4-5}
		BanpS.2.1.1 & 3.1.2.6.3.3.1 & & Un "+" vert est présent en bas a droite & \\
		\cline{1-2}\cline{4-5}
