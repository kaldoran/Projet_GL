...
\begin{center}
	...
	\begin{tabular}{|p{1.5cm}|p{2cm}|p{8.5cm}|p{8.5cm}|p{5cm}|}
		...
		\rowcolor{gris}Référence & Exigence & Test & Résultat attendu & Résultat/Commentaires\\
		\hline
		PicoS.1 & 3.1.2.9.1.1 & Lancer le serveur et pingger le port 21 du serveur. & Le serveur répond. & \\
		\cline{1-2}\ccline{3-3}{gris}\cline{4-5}
		PicoS.2 & 3.1.2.9.1.2 & Lancer le serveur. & Vérifier que le port utilisé est supérieur a 1024 pour chaque nouveau client. & \\
		\cline{1-2}\ccline{3-3}{gris}\cline{4-5}
		PicoS.3 & 3.1.2.9.1.3 & Faire une demande au serveur à partir d'un client. & Le programme communique par le port définit. & \\
		\hline
	\end{tabular}
	\egroup
\end{center}

\subsubsection{Procédure de fermeture de la communication Client-Serveur}
\begin{center}
	\bgroup
	\def\arraystretch{1.5}
	\begin{tabular}{|p{1.5cm}|p{2cm}|p{8.5cm}|p{8.5cm}|p{5cm}|}
		...
		\rowcolor{gris}Référence & Exigence & Test & Résultat attendu & Résultat/Commentaires\\
		\hline
		PfccS.1 & 3.1.2.9.2 & Lancer un téléchargement a partir du client et fermer le serveur. & Le téléchargement se coupe. & \\
		\hline
	\end{tabular}
	\egroup
\end{center}
