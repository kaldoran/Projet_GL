...
\begin{center}
	...
	\begin{tabular}{|p{2.2cm}|p{2cm}|p{8.5cm}|p{8.5cm}|p{5cm}|}
		...
		\rowcolor{gris}Référence & Exigence & Test & Résultat attendu & Résultat/Commentaires\\
		\hline
		BanpS.1 & 3.1.2.6.1 & Cliquer sur un compte puis sélectionner un fichier dans la zone de droite et cliquer sur "-" & L'utilisateur n'a plus les droits sur le fichier. & \\
		\cline{1-2}\ccline{3-3}{gris}\cline{4-5}
		BanpS.2 & 3.1.2.6.2 & Donner une raison au bannissement. & Vérifier que le motif est présent dans le fichier .accban. & \\
		\cline{1-2}\ccline{3-3}{gris}\cline{4-5}
		BanpS.3 & 3.1.2.6.3 & Cliquer sur un compte puis Cliquer sur le moins de la partie droite. & Un champs permet de donner la durée du bannissement.  & \\
		\hline
	\end{tabular}
	\egroup
\end{center}
