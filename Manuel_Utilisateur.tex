...
\section{Principe de fonctionnement du serveur}

\underline{Attention} : Cette partie ne sera pas autant détaillé que la première, pour cause, cette partie est réservé a des utilisateurs 'expérimenté'
