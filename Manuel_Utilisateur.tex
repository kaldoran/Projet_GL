...
Après avoir double cliqué sur les icônes du programme les fenêtres suivantes apparaîtront. 
...
\underline{A noter} : Si le serveur est en local ( sur votre propre machine ). \\
l'adresse du serveur sera alors : \textbf{127.0.0.1} \\

Le nom d'utilisateur et le mot de passe vous seront fournis par le responsable du serveur.
...
Si vous cliquez sur annuler, vous aurez alors accès aux options mais pas aux fichiers du serveur.
\subsection{Les cas d'erreur}

Plusieurs cas d'erreur / messages d'erreurs peuvent apparaitre. \\
...
\begin{center}
	...
	A gauche : Les fichiers présents sur votre ordinateur. \\
