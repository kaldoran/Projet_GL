...
\paragraph{Gestionnaire de comptes utilisateurs}
	\begin{enumerate}
		...
		\item Le programme doit se souvenir de tous les comptes crées.
...
\paragraph{Stockage des comptes}
	\begin{enumerate}
		\item Le programme doit contenir dans un fichier les mots de passe sous une forme cryptée. \textcolor{blue}{cf Cryptage}
