...
\paragraph{Authentification}
	...
	\begin{enumerate}
		\item Le formulaire de connexion doit etre de type Pop-up.
		\item Le formulaire se situera au milieu de la fenetre.
		\item Le Pop-Up de connexion apparaitra des l'ouverture du logiciel.
		\item Quand le Formulaire sera présent le bouton déconnexion sera desactivé / grisé
