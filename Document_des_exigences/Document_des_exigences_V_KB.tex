	...
	\begin{enumerate}
		...
		\item Deux boutons seront présent en bas de cette zone.
			\begin{enumerate}[label=\arabic*.]
				...
				\item Au clic sur le bouton "-" un pop-up s'ouvrira. Voir \hyperref[del]{\ref{del}} Page : \pageref{del}
				\item Un bouton en bas a gauche avec un "+" vert dedans.\label{bdv}
				\item Au clic sur le bouton "+" un pop-up s'ouvrira. Voir \hyperref[add]{\ref{add}} Page : \pageref{add}
			\end{enumerate} 
		...
		\item Lors du clic sur un compte, la fenêtre de droite changera, elle contiendra alors les répertoire auquel l'utilisateur sélectionné à accès. Voir \hyperref[chg]{\ref{chg}} Page : \pageref{chg}
	\end{enumerate}
	
	
>>>>>>> 65765c2d5c9912ee8c0a002fca5fe44471e20b66
...
<<<<<<< HEAD
	...
	\end{enumerate}
=======
		\item Le pop-up doit contenir deux case à cocher :
			\begin{enumerate}[label=\arabic*.]
				\item Une case alignée avec le texte "Supprimer le compte"
				\item Une case alignée avec le texte "Bannir le compte"
			\end{enumerate} 
		\item Seule une des deux cases peut être cochée.
		\item En bas de ce pop-up se trouverons deux boutons :
			\begin{enumerate}[label=\arabic*.]
				\item Un bouton annulé, qui annulera toute la procédure.
				\item Un bouton validé qui validera la procédure.
			\end{enumerate} 
...
\paragraph{Interface graphique ajout de compte}\label{add} 
		\begin{enumerate}
...
\paragraph{Interface graphique changement droits}\label{chg} 
		\begin{enumerate}
...
>>>>>>> 65765c2d5c9912ee8c0a002fca5fe44471e20b66
	...
	\subparagraph{Comptes temporaires}
		\begin{enumerate}
			...
			\item A la fin du Timestamp le compte ne sera plus accessible.
		\end{enumerate}
...
\paragraph{Module de statistique \\ \\}
	...
	\subparagraph{Interface graphique}
		\begin{enumerate}
			...
			\item Les noms de chaque utilisateur (ayant effectuer un upload et un download) doit être correspondre à un numéro unique, ce numéro unique doit apparaître en abscisse de l'histogramme H2.
