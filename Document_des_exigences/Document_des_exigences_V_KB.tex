...
\paragraph{Gestionnaire de comptes utilisateurs}
	\begin{enumerate}
		...
		\item Le programme doit se souvenir de tout les comptes crée.\textcolor{blue}{ c.f \ref{cpt} }
...
\paragraph{Interface graphique changement droits}\label{chg} 
	...
	\subparagraph{Comptes temporaires}
		\begin{enumerate}
			...
			\item Le stockage sera sous la forme : TempsEnSeconde$ \vert $pseudo@motDePasse:/fichier\#/autrefichier
		\end{enumerate}
