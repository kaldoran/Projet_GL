...
\paragraph{Authentification}
	\begin{itemize}[label = $\triangleright$]
		...
		\item Le programme doit indiqué le succès a l'aide la phrase "Bonjour [pseudo]"\textcolor{green}{Où ?}.
		...
		\item Le programme doit permettre l'auto-connexion au démarrage du programme\textcolor{green}{Où est-ce que l'utilisateur peut configurer l'auto-connexion?}.
	\end{itemize}
	
	\item \textcolor{green}{que se passe t-il si l'anthentification échoue?}
	
	\item \textcolor{green}{ si le login est erroné?}
	
	\item \textcolor{green}{ si le mot de passe est erroné ?}
	

\paragraph{Gestionnaire de marque-pages}
	\begin{itemize}[label = $\triangleright$]
		\item Le programme devrait proposer un gestionnaire de marque-pages de serveur.
		\item Le programme devrait afficher un bouton "Bookmarks".\textcolor{green}{Où est positionné le bouton?}
		\item Cliquer sur le bouton "Bookmarks" devrait afficher la liste des marques-pages de l'utilisateur.\textcolor{green}{Où la liste des marques-pages est affiché dans quoi ?}
		\item Un marque-page doit se composer obligatoirement d'un nom, de l'adresse du serveur, de l'identifiant de l'utilisateur.\textcolor{green}{exemple de syntaxe ?}
		\item Un marque-page doit avoir la possibilité d'enregistrer aussi le mot de passe de l'utilisateur si ce dernier le veut.
		\item Le programme devrait afficher un bouton "Mettre un marque-page".\textcolor{green}{Où est positionné ce bouton ?}
...
\paragraph{Limitations}
	\begin{itemize}[label = $\triangleright$]
		...
		\item Pour cela le menu déroulant "Configuration" doit proposer un bouton "Limiter vitesse de téléchargement".\textcolor{green}{Où est ce menu déroulant sur l'interface graphique?}
...
\paragraph{Utilisation des dossiers}
	\begin{itemize}[label = $\triangleright$]
		\item Le programme doit afficher l'arborescence des dossiers auquel l'utilisateur a accès sur le serveur courant.\textcolor{green}{Où est-ce qu'il affiche cette arborescence ? dans une fenêtre à part ? sur la même fenêtre dans une partie à gauche ? dans ton *** ?}
...
\begin{itemize}
	...
	\item L'utilisateur après une formation d'une demie heure, ne doit pas faire plus 10 erreur de manipulation sur une durée de 4h.
...
\paragraph{Fiabilité du fonctionnement général du logiciel}
	...
	\begin{itemize}[label = $\triangleright$]
		\item Le client ne doit pas présenter de bugs pendant les 5 premier mois après le déploiement.
