...
\paragraph{Authentification}
	...
	\begin{enumerate}
		...
		\item Le Pop-Up de connexion doit apparaître dès l'ouverture du logiciel.
		...
		\item En cas d'erreur, un cadre aux bordures rouges doit apparaître au dessus du champ concerné.
...
\paragraph{Download et Upload}
	...
	\begin{enumerate}
		...
		\item Le client doit pouvoir uploader des fichiers sur n'importe quel serveur FTP, et à condition que la connexion soit établis entre celui-ci et le client.
...
\subparagraph{Interface graphique bannissement \& suppression}\label{del} 
	...
	\subparagraph{Interface graphique changement droits}\label{chg} 
		\begin{enumerate}
			\item Dans la partie droite du programme ce trouvera par défaut la liste de tout les fichiers accessible sur le serveur.
